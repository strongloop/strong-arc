  ...
  ['LoopBackResource', 'LoopBackAuth', function(Resource, LoopBackAuth) {
    return Resource(
      ...
      { 'id': '@id' },
      {
         ...
         */
        "findOne": {
          url: urlBase + "/apidefinitions/findOne",
          method: "GET",
        },
        /**
         * @ngdoc method
  ...
  ['LoopBackResource', 'LoopBackAuth', function(Resource, LoopBackAuth) {
    return Resource(
      ...
      { 'id': '@id' },
      {
         ...
         */
        "findOne": {
          url: urlBase + "/datasourcedefs/findOne",
          method: "GET",
        },
        /**
         * @ngdoc method
